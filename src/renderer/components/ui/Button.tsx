...
export default function Button({
  ...
  const classes = [
    'inline-flex items-center justify-center font-semibold rounded-lg whitespace-nowrap transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed',
